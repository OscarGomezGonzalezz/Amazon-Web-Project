...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['email']) && !empty($_POST['email'])){
        ...
        if ($count < 0) {
            echo json_encode(['success' => false, 'message' => 'Email doesnt exists.']);
            exit;
        }
        ...
        try {
            ...
            echo json_encode(['success' => true, 'message' => 'New password sent successful. Check your email for the temporary password.']);
        } catch (Exception $e) {
