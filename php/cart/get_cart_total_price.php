...
if(isset($_SESSION['userId'])){
    ...
    $stmt = $conn->prepare("SELECT SUM(Articles.price * Cart.quantity) AS total_cart_price FROM Cart JOIN Articles ON Cart.article_id = Articles.article_id WHERE Cart.user_id = ?");
